                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-1 gap-8 lg:gap-2">
                        ...
                        <div class="px-8 py-4 lg:px-8">
                            ...
                            <p class="text-md text-gray-700 leading-relaxed">
                                Our Managed Services are designed to strengthen and streamline your corporate functions, allowing businesses to focus on growth while we handle the day-to-day financial responsibilities with accuracy, compliance, and efficiency. Acting as an extension of your internal team, we help you optimize performance, ensure regulatory adherence, and build a scalable team that supports long-term growth.

                            </p>
                            <p class="text-md text-gray-700 leading-relaxed mt-4">
                               We take a proactive approach to managing your technology, ensuring optimal performance, reduced downtime, and enhanced security. From day-to-day operations to long-term strategy, our team becomes an extension of yours.
