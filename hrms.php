        ...
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            ...
            <div class="mt-4 flex justify-center">
                <div
                    ...
                    <p class="text-gray-900">HRMS Implementation</p>
                ...
                <div id="erp" class="tab-panel">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-2">
                        ...
                        <div class="px-8 py-4 lg:px-8 mb-5">
                            ...
                            <p class="text-md text-gray-700 leading-relaxed mb-6">
                                At ARSI, we specialize in end-to-end ERP implementation services that help businesses unify their processes, enhance productivity, and gain real-time insights. Whether you're upgrading from legacy systems or adopting ERP for the first time, our experienced team ensures a seamless transition tailored to your unique business needs.
                            </p>
                                ...
                                <div class="space-y-4">
                                    <ul class="ps-0">
                                            ...
                                            <p class="text-gray-600 text-medium">                                            
                                                With years of hands-on experience across industries, we deliver ERP solutions that work — on time and within budget.                                              
                                            </p>
                                            ...
                                            <p class="text-gray-600 text-medium">                                             
                                                We don’t believe in one-size-fits-all. Our implementation process is fully customized to align with your workflows, goals, and business culture.
                                            </p>
                                            ...
                                            <p class="text-gray-600 text-medium">                                               
                                                From discovery and planning to training and post-launch support, we’re with you every step of the way.
                                            </p>       
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5">
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <div class="space-y-4">
                                <ol class="ps-0">
                                    <li class="before:content-['1'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Discovery & Needs Assessment</li>
                                    <p class="text-gray-600 text-medium">   
                                        We begin by understanding your business processes, pain points, and goals to define the right ERP strategy.

                                    </p>
                                    <li class="before:content-['2'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">System Selection</li>
                                    <p class="text-gray-600 text-medium">
                                        We help you choose the best ERP platform for your industry and scale — whether it’s SAP, Oracle, Microsoft Dynamics, NetSuite, or others.
                                    </p>
                                    <li class="before:content-['3'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Planning & Roadmap</li>
                                    <p class="text-gray-600 text-medium">                                       
                                        Our team develops a detailed implementation plan, complete with timelines, milestones, and resource allocation.
                                    </p>
                                    <li class="before:content-['4'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Customization & Integration</li>
                                    <p class="text-gray-600 text-medium">                                        
                                        We tailor the ERP system to your needs and integrate it with existing systems like CRM, HR, finance, or supply chain.                                        
                                    </p>
                                    <li class="before:content-['5'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Data Migration</li>
                                    <p class="text-gray-600 text-medium">
                                        We ensure a secure, accurate transfer of your historical data into the new ERP system.
                                    </p>
                                    <li class="before:content-['6'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Testing & Quality Assurance</li>
                                    <p class="text-gray-600 text-medium">
                                        Rigorous testing is conducted to ensure every module functions flawlessly before going live.
                                    </p>
                                    <li class="before:content-['7'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Training & Change Management</li>
                                    <p class="text-gray-600 text-medium">                                   	
                                        We equip your team with the training and tools they need to adapt and thrive in the new ERP environment.
                                    </p>
                                    <li class="before:content-['8'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Go-Live & Ongoing Support</li>
                                    <p class="text-gray-600 text-medium">                                        	
                                        Once live, we continue to monitor performance, address issues, and provide updates as needed.
                                    </p>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="px-8 py-4 lg:px-12 mb-5 text-center">
                        ...
                        <div class="space-y-4">
                            <p class="text-md text-gray-700 leading-relaxed">
                                Let us guide you through a successful ERP journey. Contact us today for a free consultation and see how we can help your business scale smarter and faster.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div id="crm" class="tab-panel hidden">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5">
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <div class="space-y-4">
                                <ol class="ps-0">
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">CRM Strategy & Planning</li>
                                    <p class="text-gray-600 text-medium">
                                        
                                        We assess your current customer management processes and define a roadmap aligned with your goals.
                                        
                                        
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">CRM Platform Selection</li>
                                    <p class="text-gray-600 text-medium">
                                        Whether you need Salesforce, HubSpot, Microsoft Dynamics, Zoho, or another solution, we help you choose the best-fit platform for your business size, industry, and needs.
                                        
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">System Design & Configuration</li>
                                    <p class="text-gray-600 text-medium">
                                        We configure your CRM with custom fields, workflows, dashboards, and modules to match how your business operates.
                                        
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Data Migration & Integration</li>
                                    <p class="text-gray-600 text-medium">
                                        
                                        We handle secure data migration from legacy systems and integrate your CRM with tools like ERP, marketing automation, email, and support platforms.
                                        
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">User Training & Adoption</li>
                                    <p class="text-gray-600 text-medium">
                                        Our hands-on training programs ensure your teams understand how to use the CRM effectively from day one.
                                        
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Post-Implementation Support</li>
                                    <p class="text-gray-600 text-medium">
                                        We offer ongoing support, system optimization, and performance monitoring to keep your CRM running smoothly.through automation, system integration, and digital adoption.
                                    </p>
                                </ol>
                            </div>
                        </div>
                ...
                <div id="yapp" class="tab-panel hidden">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-2">
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center gap-4">
                                    <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                    <span class="text-md"><b>Sales & Marketing:</b> Leads falling through the cracks? Campaigns not converting?
                                        </span>
                                </div>
                                <div class="flex items-center gap-4">
                                    <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                    <span class="text-md"><b>Finance:</b> Manual invoice processing, slow reconciliations?
                                        </span>
                                </div>
                               
                                <div class="flex items-center gap-4">
                                    <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                    <span class="text-md"><b>Customer Support:</b>Repetitive ticket handling and delayed responses?</span>
                                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5">
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <div class="space-y-4">
                                <ol class="ps-0">
                                    <li class="before:content-['🚫'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Manual, Time-Consuming Processes</li>
                                    <p class="text-gray-600 text-medium">
                                        Are your teams still juggling spreadsheets, email chains, or repetitive tasks? We help identify and automate the bottlenecks that slow your business down.
                                    </p>
                                    
                                    <li class="before:content-['⚠️'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">   Disconnected Systems & Tools</li>
                                    <p class="text-gray-600 text-medium">
                                      
                                        Using multiple platforms that don’t “talk” to each other? We design integrated automation workflows that eliminate silos and data inconsistencies.
                                    </p>
                                    <li class="before:content-['🔍'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Lack of Visibility & Control</li>
                                    <p class="text-gray-600 text-medium">
                                        
                                        Struggling to get real-time insights into operations, tasks, or customer interactions? We implement dashboards and reporting that put you back in control.
                                    </p>
                                    <li class="before:content-['📉'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2"> Failed or Stalled Automation Initiatives</li>
                                    <p class="text-gray-600 text-medium">
                                        
                                        Have automation projects gone over budget, beyond deadlines, or failed to deliver ROI? We step in with expert project recovery, optimization, and support.
                                    </p>
                                    <li class="before:content-['👥'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2"> Low User Adoption</li>
                                    <p class="text-gray-600 text-medium">
                                        
                                        Even the best automation fails without buy-in. We create intuitive systems with training and change management to ensure successful adoption.
                                    </p>
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            <div class="space-y-4">
                                ...
                                <div class="space-y-4">
                                    <ol class="ps-0">
                                        <li class="before:content-['1'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Listen First</li>
                                        <p class="text-gray-600 text-medium">
                                        ...
                                        <li class="before:content-['2'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Audit & Assess</li>
                                        <p class="text-gray-600 text-medium">  
                                            Our experts evaluate your current systems, tools, and processes to uncover root causes.
                                        </p>
                                        <li class="before:content-['3'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Design Smarter Workflows</li>
                                        <p class="text-gray-600 text-medium">
                                            We design customized automation strategies that align with your business — not the other way around.
                                            
                                        </p>
                                        <li class="before:content-['4'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2"> Implement & Integrate Initiatives</li>
                                        <p class="text-gray-600 text-medium">	
                                            We use the right tools (like Zapier, Power Automate, UiPath, Make, or custom scripts) to build scalable automations.
                                           
                                        </p>
                                        <li class="before:content-['5'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Train & Support</li>
                                        <p class="text-gray-600 text-medium">
                                           
                                            Your team gets hands-on training, documentation, and post-launch support to make automation stick.
                                        </p>
