        ...
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            ...
            <div class="mt-4 flex justify-center">
                <div
                    ...
                    <p class="text-gray-900">Virtual CFO</p>
                ...
                <div id="erp" class="tab-panel">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-2">
                        ...
                        <div class="px-8 py-4 lg:px-8 mb-5">
                            ...
                            <p class="text-md text-gray-700 leading-relaxed mb-6">
                                In today’s complex regulatory environment, accurate and timely financial reporting isn’t just a compliance requirement — it’s a strategic necessity. At <b>[Your Company Name]</b>, our Financial Reporting Advisory services help you navigate evolving accounting standards, prepare for audits, and deliver transparent, investor-ready financial information.
                            </p>
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <p class="text-md text-gray-700 leading-relaxed">
                                Whether you're a fast-growing private company, a publicly listed organization, or preparing for an IPO, our team of financial reporting experts ensures that your reporting is accurate, efficient, and aligned with the latest standards and best practices.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5">
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <div class="space-y-4">
                                <ol class="ps-0">
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Financial Statement Preparation & Review</li>
                                    <p class="text-gray-600 text-medium">
                                        We assist with the preparation or review of GAAP/IFRS-compliant financial statements — from annual reports to interim disclosures.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Technical Accounting Advisory</li>
                                    <p class="text-gray-600 text-medium">
                                        We provide guidance on complex accounting matters such as revenue recognition (ASC 606 / IFRS 15), leases (ASC 842 / IFRS 16), stock-based compensation, and more.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Regulatory Compliance & Disclosures</li>
                                    <p class="text-gray-600 text-medium">
                                        We help ensure your financial reporting complies with local and international regulatory requirements, including SEC, PCAOB, and other relevant authorities.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">IPO & Capital Markets Readiness</li>
                                    <p class="text-gray-600 text-medium">
                                        Planning a public offering or private equity transaction? We prepare your financials for due diligence and help you meet all disclosure obligations.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Financial Restatements & Adjustments</li>
                                    <p class="text-gray-600 text-medium">
                                        We assist in identifying, correcting, and restating financial information due to errors, changes in accounting principles, or audit findings.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Interim & Quarterly Reporting Support</li>
                                    <p class="text-gray-600 text-medium">
                                        Timely and accurate reporting during busy periods, supported by scalable resources and financial reporting expertise.
                                    </p>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                    <span class="text-md font-bold">Entering new markets or restructuring operations</span>
                                </div>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                    <span class="text-md font-bold">Experiencing internal staffing gaps in finance</span>
                                </div>
                                <div class="flex items-center gap-4">
                                    <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                    <span class="text-md font-bold">Facing complex transactions that require technical interpretation</span>
                                </div>
                            </div>
                                ...
                                <div class="space-y-4">
                                    <ul class="ps-0">
                                        <li
                                            ...
                                            <p class="text-gray-600 text-medium">
                                                Our team brings in-depth knowledge of U.S. GAAP, IFRS, and regulatory frameworks, combined with practical industry experience.
                                            </p>
                                        ...
                                        <li
                                            ...
                                            <p class="text-gray-600 text-medium">
                                                We understand what auditors and regulators expect. Our work stands up to scrutiny, minimizing last-minute surprises.
                                            </p>
                                        ...
                                        <li
                                            ...
                                            Scalable Support</li>
                                            <p class="text-gray-600 text-medium">
                                                From one-time technical projects to ongoing advisory partnerships, we offer flexible solutions to fit your needs and timelines.
                                            </p>
                                        ...
                                        <li
                                            ...
                                            <p class="text-gray-600 text-medium">
                                                We make complex financial reporting matters understandable for all stakeholders — from the CFO to your board of directors.
                                            </p>
                    ...
                    <div class="px-8 py-4 lg:px-12 mb-5 text-center">
                        ...
                        <div class="space-y-4">
                            <p class="text-md text-gray-700 leading-relaxed">
                                With our <b class="text-blue-700">Financial Reporting Advisory services</b>, you gain more than compliance — you gain clarity, confidence, and control. Let us help you deliver financial information that builds trust and supports strategic decisions.
                ...
                <div id="hrms" class="tab-panel hidden">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5">
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <div class="space-y-4">
                                <ol class="ps-0">
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Financial Strategy & Planning</li>
                                    <p class="text-gray-600 text-medium">
                                        Develop long-term financial strategies aligned with your business goals — including budgeting, forecasting, and scenario planning.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Cash Flow & Working Capital Management</li>
                                    <p class="text-gray-600 text-medium">
                                        Gain full visibility into your cash flow and improve liquidity management to support day-to-day operations and growth.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">KPI Development & Performance Reporting</li>
                                    <p class="text-gray-600 text-medium">
                                        Track what matters. We define and monitor key metrics to help you make informed, data-driven decisions.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Investor & Stakeholder Reporting</li>
                                    <p class="text-gray-600 text-medium">
                                        Prepare professional financial reports for investors, lenders, and board members. We help you tell your financial story with clarity and confidence.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Fundraising & Capital Advisory</li>
                                    <p class="text-gray-600 text-medium">
                                        Whether you’re raising seed funding, seeking loans, or preparing for Series A/B, we help you get financially investor-ready.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Risk Management & Compliance</li>
                                    <p class="text-gray-600 text-medium">
                                        Ensure financial controls, governance, and compliance with tax, regulatory, and audit requirements.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Profitability & Cost Optimization</li>
                                    <p class="text-gray-600 text-medium">
                                        We analyze your cost structure, margins, and pricing strategies to boost profitability and improve financial efficiency.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Finance Team Mentorship</li>
                                    <p class="text-gray-600 text-medium">
                                        Need to strengthen your internal finance function? We mentor and support your accounting team for long-term sustainability.
                                    </p>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="space-y-4">
                                    <ul class="">
                                        <li
                                            ...
                                            <p class="text-gray-600 text-medium">
                                                Access decades of CFO-level experience at a fraction of the cost of hiring in-house.
                                            </p>
                                        ...
                                        <li
                                            ...
                                            <p class="text-gray-600 text-medium">
                                                Choose the support level you need — monthly oversight, weekly calls, or project-based services.
                                            </p>
                                        ...
                                        <li
                                            ...
                                            <p class="text-gray-600 text-medium">
                                                We blend strategic thinking with actionable recommendations tailored to your market and growth stage.
                                            </p>
                                        ...
                                        <li
                                            ...
                                            <p class="text-gray-600 text-medium">
                                                We act in your best interest — always. You get independent advice backed by data and experience.
                                            </p>
                ...
                <div id="crm" class="tab-panel hidden">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5">
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            ...
                            <div class="space-y-4">
                                <ol class="ps-0">
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Business Strategy Development</li>
                                    <p class="text-gray-600 text-medium">
                                        Develop long-term financial strategies aligned with your business goals — including budgeting, forecasting, and scenario planning.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Cash Flow & Working Capital Management</li>
                                    <p class="text-gray-600 text-medium">
                                        Define your vision, goals, and competitive edge. We help you create a focused strategy that drives long-term success.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Operational Efficiency & Process Improvement</li>
                                    <p class="text-gray-600 text-medium">
                                        Streamline your operations, eliminate inefficiencies, and improve productivity across your organization.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Financial Planning & Analysis</li>
                                    <p class="text-gray-600 text-medium">
                                        Gain control over your finances. We provide forecasting, budgeting, cost optimization, and financial modeling support.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Digital Transformation</li>
                                    <p class="text-gray-600 text-medium">
                                        Leverage technology to modernize your business. We guide you through automation, system integration, and digital adoption.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Market Entry & Growth Strategy</li>
                                    <p class="text-gray-600 text-medium">
                                        Entering a new market or launching a new product? We deliver the market research and strategy to make your move successful.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Change Management</li>
                                    <p class="text-gray-600 text-medium">
                                        We help your team adapt to change with structured communication, training, and implementation planning.
                                    </p>
                                    <li class="before:content-['✔'] before:mr-2 before:inline-block font-bold text-md mt-2 mb-2">Risk & Compliance Advisory</li>
                                    <p class="text-gray-600 text-medium">
                                        Identify risks and ensure regulatory compliance to protect your business and reputation.
                                    </p>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="px-8 py-4 lg:px-12 mb-5">
                            <div class="space-y-4">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center gap-4">
                                        <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                        <span class="text-md">Startups needing strategic direction and growth plans</span>
                                    </div>
                                    <div class="flex items-center gap-4">
                                        <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                        <span class="text-md">Small to medium-sized businesses seeking operational efficiency
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                        <span class="text-md">Enterprises navigating digital transformation or restructuring</span>
                                    </div>
                                   
                                    <div class="flex items-center gap-4">
                                        <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                        <span class="text-md">Business owners preparing for expansion, funding, or succession</span>
                                    </div>
                                   
                                    <div class="flex items-center gap-4">
                                        <div class="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div>
                                        <span class="text-md">Organizations facing specific challenges like low profitability or market decline</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-4 mt-6">
                                ...
                                <div class="space-y-4">
                                    <ul class="">
                                        ...
                                        <li
                                            ...
                                            <p class="text-gray-600 text-medium">
                                                We work with your leadership and teams — not just for you — to ensure alignment and ownership at every level.
