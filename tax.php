                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-1 gap-8 lg:gap-2">
                        ...
                        <div class="px-8 py-4 lg:px-8">
                            ...
                            <p class="text-md text-gray-700 leading-relaxed">
                                Our Tax Compliance and Tax Planning services help individuals and organizations meet their regulatory obligations while optimizing their tax position. We combine technical expertise with strategic insight to ensure compliance, minimize risk, and support long-term financial efficiency.
                            </p>
                            <p class="text-md text-gray-700 leading-relaxed mt-4">
                              Whether navigating complex regulations or planning for future growth, we provide reliable guidance tailored to your specific needs
                            </p>
